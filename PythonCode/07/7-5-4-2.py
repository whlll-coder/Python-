...
weather_indexes = [['temperature', 'sunhour'],
                   ['temperature', 'sunhour', 'month'],
                   ['temperature', 'sunhour', 'dayofyear'],
                   ['temperature', 'sunhour', 'hour'],
                   ['temperature', 'sunhour', 'month','dayofyear'],
                   ['temperature', 'sunhour', 'month','hour'],
                   ['temperature', 'sunhour', 'dayofyear','hour'],
                   ['temperature', 'sunhour', 'month', 'dayofyear', 'hour']]


for i in range(len(weather_indexes)):
    weather_index = weather_indexes[i]
    print("\n")    
    print(weather_index)    
    
    takamatsu = elec_data.join(tmp[weather_index]).dropna().values
